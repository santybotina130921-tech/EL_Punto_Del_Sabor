...
<body class="font-sans text-gray-800 min-h-screen flex flex-col">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            <div>
                ...
                <p class="text-gray-600 mt-1 text-sm">
                    Registra las ventas de útiles, fotocopias y servicios escolares al instante con descuento de stock.
                </p>
            </div>
            ...
            <div class="relative min-w-[280px] w-full md:w-auto">
                ...
                <input type="text" id="buscador" placeholder="Buscar cuaderno, lápiz, fotocopia..." 
                       class="w-full pl-9 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-yellow-400/20 focus:border-yellow-500 shadow-sm transition-all">
            </div>
        </div>

        <form action="index.php?url=guardar_venta" method="POST">
            <input type="hidden" name="tipo_negocio" value="papeleria">

            <!-- Grid de Productos -->
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-8">
                <?php if (empty($productos)): ?>
                    <div class="col-span-full text-center text-gray-500 py-12 bg-white rounded-2xl border border-gray-200">
                        No hay artículos registrados en el menú de papelería.
                    </div>
                <?php else: ?>
                        ...
                        <div class="tarjeta-producto bg-slate-950 text-white rounded-2xl overflow-hidden shadow-md border border-slate-900 flex flex-col justify-between">
                            ...
                            <div class="p-4 flex-grow flex flex-col justify-between">
                                <div>
                                    ...
                                    <div class="text-yellow-400 font-extrabold text-xl mt-1">
                                ...
                                <div class="mt-4">
                                    ...
                                    <input type="number" 
                                           ...
                                           class="w-full bg-slate-900 border border-slate-800 rounded-xl px-3 py-2 text-center text-white font-bold focus:outline-none focus:border-yellow-400 text-sm" 
                    ...
                    <!-- Alerta de "No se encontraron resultados" -->
            ...
            <div class="bg-slate-950 text-white rounded-2xl p-5 shadow-lg flex flex-col sm:flex-row items-center justify-between gap-4 border border-slate-900">
                ...
                <div class="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
                    <select name="metodo_pago" class="bg-slate-900 border border-slate-800 text-sm font-semibold rounded-xl px-4 py-2.5 text-white focus:outline-none focus:border-yellow-400 w-full sm:w-44">
                    ...
                    <button type="submit" class="bg-yellow-400 hover:bg-yellow-500 text-slate-950 font-black text-sm uppercase tracking-wider px-6 py-3 rounded-xl transition-all shadow-md w-full sm:w-auto cursor-pointer">
                        ⚡ Registrar Venta
                    </button>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // 2. Lógica para filtrar las tarjetas de útiles escolares
            if (buscador) {
